...
if (isset($pengunjung->alamat->email)) {
...
<body>
    ...
    <div class="container">
        <div class="row pt-5">
            <a type="button" href="detailVisitor.php?nik=<?= $pengunjung->NIK ?>"
                class="btn btn-outline-secondary">Back</a>
            <div class="col-12 pt-3">
                <h1 class="text-center mb-5">Edit Visitor Data</h1>
                <form class="w-50 ml-auto mr-auto" action="edit.php" method="POST">
                    <div class="form-group">
                        <input type="hidden" class="form-control bg-dark text-white" name="nik_old"
                            value="<?= $pengunjung->NIK ?>">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Nama<span style="color: yellow;">*</span></label>
                        <input type="text" class="form-control bg-dark text-white" name="nama"
                            value="<?= $pengunjung->nama ?>" required>
                    </div>
                    <fieldset>
                        <legend>Alamat:</legend>
                        <div class="form-group">
                            <label for="formGroupExampleInput2">Jalan<span style="color: yellow;">*</span></label>
                            <input type="text" class="form-control bg-dark text-white" name="jalan"
                                value="<?= $pengunjung->alamat->jalan; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="formGroupExampleInput2">Kota<span style="color: yellow;">*</span></label>
                            <input type="text" class="form-control bg-dark text-white" name="kota"
                                value="<?= $pengunjung->alamat->kota; ?>" required>
                        </div>
                        <div class="form-group">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control bg-dark text-white" name="telp"
                                value="<?= $pengunjung->kontak->phone; ?>" required>
                        </div>
                    </fieldset>
                    ...
                    <div class="text-center">
                        <button type='submit' name="update"
                            class="btn btn-primary btn-lg w-100 mt-5 mb-4">Update</button>
                    </div>
                </form>
            </div>
        </div>
